...
| Static components | `.px-frame` pixel box · `.px-btn` sketch button · `.px-card` sketch card (build-time rough.js border) · `.px-dialogue` RPG dialogue · `.px-note` / `.px-arrow` annotation · `.px-xp` / `.px-hp` meters | ✅ 6 of 8 |
| More static | HUD chip · quest-select list | planned |
